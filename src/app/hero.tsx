...
export function WelcomePage() {
  ...
  return (
    <div className="h-screen relative w-full overflow-hidden bg-slate-900 flex flex-col items-center justify-center rounded-lg">
      ...
      <div id="DivLeft"  className="h-screen w-full flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
        ...
        <div id="DivRight" className="flex-1 overflow-y-auto md:overflow-y-scroll right-side-div flex flex-col items-start justify-start md:pl-20">
          <ProjectCards />
        </div>
      </div>
    </div>
